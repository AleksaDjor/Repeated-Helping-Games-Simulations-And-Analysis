...
people (in our simulations m = 6), each substrategy appearing with a probability
represented in the probability distribution presented above.
...
simulate <- function(num_players = 6, num_rounds = 100, substrategy_probabilities, sender_payoff = 150, receiver_payoff = 250, starting_money = 3000, error_rate = 0.05) {
  ...
  #[round, player1_id, player2_id, player_1_substrategy, player_1_action, player_1_history, player_2_history, player_1_budget, player_2_budget, exp_history, sender_number_of_helps, receiver_number_of_helps] for each round played among the pairs
  ...
  # both of which appear with a probability 50% for each action
...
simulate(substrategy_probabilities = substrategy_probabilities)
```
...
test_predict_0.00_first <- predictions_df(number_of_experimental_groups = num_simulations, number_of_experimental_groups_MLFIT = 10, size_of_experimental_group = 6)
# test_predict_0.00_first
```
...
#       simulation_list <- simulate_data(num_simulations, num_players, num_rounds, substrategy_probabilities = first_substrategy_probabilities, sender_payoff, receiver_payoff, starting_money, error_rate)
#       predict_0_first <- predictions_df(number_of_experimental_groups = num_simulations, number_of_experimental_groups_MLFIT = 10, size_of_experimental_group = 6)
#       write.csv(predict_0_first,"~/Downloads/predict_0_first.csv", row.names = FALSE)
#         
#       }
# }
# 
...
#       else if (error_rate == 0) {
#       simulation_list <- simulate_data(num_simulations, num_players, num_rounds, substrategy_probabilities = second_substrategy_probabilities, sender_payoff, receiver_payoff, starting_money, error_rate)
#       predict_0_second <- predictions_df(number_of_experimental_groups = num_simulations, number_of_experimental_groups_MLFIT = 10, size_of_experimental_group = 6)
#       write.csv(predict_0_first,"~/Downloads/predict_0_second.csv", row.names = FALSE)
#         
#       }
# }
...
```{r}
# We load the data sets from the simulations as a check
first_0 <- read.csv("~/Downloads/predict_0_first.csv", header=TRUE)
...
second_0 <- read.csv("~/Downloads/predict_0_second.csv", header=TRUE)
